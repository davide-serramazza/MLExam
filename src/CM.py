...
def main():
    ...
    #                                             regularization=0.01, epochs=50, epsilon=0.001)

    loss_tr, miss_tr, loss_vl, miss_vl = network.train_LBFGS(training_patterns, training_labels,
                                                 validation_patterns, validation_labels,
                                                 theta=0.9, c_1=0.0001, c_2=0.9, lossObject=lossObject,
                                                 regularization=0.01, epochs=50, epsilon=0.0001, m=10)
