                ...
                for reg in parameter.regularization:
                    for m in parameter.m:
                        ...
                        for n in range(n_trials):
                            ...
                            squared_error_validation = np.pad(squared_error_validation,(0,diff+1),'constant',constant_values=(0.0,0.0))
                            misClass_error_validation = np.pad(misClass_error_validation,(0,diff+1),'constant',constant_values=(0.0,0.0))
